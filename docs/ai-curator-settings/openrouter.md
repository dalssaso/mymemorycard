...
**IMPORTANT:** OpenRouter model names require a provider prefix (e.g., `openai/gpt-4.1-mini`, `anthropic/claude-3.5-sonnet`). See the [Models page](https://openrouter.ai/models) for the complete list.
