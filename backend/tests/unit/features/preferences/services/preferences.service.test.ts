...
import {
  createMockLogger,
  createMockPreferencesRepository,
...
describe("PreferencesService", () => {
  ...
  beforeEach(() => {
    mockRepository = createMockPreferencesRepository();
  ...
  describe("getPreferences", () => {
    ...
    it("should propagate repository errors", async () => {
      ...
      await expect(service.getPreferences(testUserId)).rejects.toThrow(
  ...
  describe("updatePreferences", () => {
    ...
    it("should propagate repository errors", async () => {
      ...
      await expect(service.updatePreferences(testUserId, { theme: "light" })).rejects.toThrow(
