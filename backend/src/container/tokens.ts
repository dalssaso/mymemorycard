...
export const GAMES_PLATFORM_REPOSITORY_TOKEN = "IGamesPlatformRepository";
...
export const ACHIEVEMENT_SERVICE_TOKEN = "IAchievementService";
export const ACHIEVEMENT_CONTROLLER_TOKEN = "IAchievementController";
