          ...
          <div className="space-y-3">
            <div>
              <div className="mb-1 flex items-center justify-between text-sm">
                ...
                <span className="font-medium text-status-finished">
                  {stats.total > 0 ? Math.round((stats.completed / stats.total) * 100) : 0}%
                </span>
              </div>
              <div className="h-2 w-full rounded-full bg-elevated">
                <div
                  className="h-2 rounded-full bg-status-finished transition-all"
                  style={{
            ...
            <div>
              <div className="mb-1 flex items-center justify-between text-sm">
                ...
                <span className="font-medium text-status-dropped">
                  {stats.total > 0 ? Math.round((stats.dropped / stats.total) * 100) : 0}%
                </span>
              </div>
              <div className="h-2 w-full rounded-full bg-elevated">
                <div
                  className="h-2 rounded-full bg-status-dropped transition-all"
                  style={{
          ...
          <div className="space-y-2">
            {recentlyPlayed.map((game) => (
              <Link
                ...
                to="/library/$id"
                params={{ id: game.id }}
                className="group flex items-center gap-3 rounded-lg p-2 transition-colors hover:bg-surface"
              >
                {game.cover_art_url ? (
                  <img
                  ...
                  <div className="flex h-14 w-10 items-center justify-center rounded bg-elevated">
