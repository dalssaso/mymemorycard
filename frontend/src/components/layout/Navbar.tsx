                          ...
                          >
                            ...
                            <div className="min-w-0 flex-1">
                              <div className="flex items-center justify-between gap-2">
                                <div className="text-sm font-medium text-ctp-text truncate">{item.name}</div>
                              ...
                              {item.type === 'game' ? (
                                <div className="mt-1">
                                  <PlatformIcons platforms={item.platforms} size="xs" maxDisplay={3} />
                                </div>
                              ) : item.type === 'platform' ? (
                                <div className="flex items-center gap-2 text-xs text-ctp-overlay1 mt-1">
                                  ...
                                  />
                                  {item.subtitle && (
                                    <span className="text-ctp-overlay1 truncate">{item.subtitle}</span>
                                  )}
                                </div>
                              ) : (
