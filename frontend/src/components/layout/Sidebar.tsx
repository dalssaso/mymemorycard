        ...
        <ScrollFade axis="y" className="h-full overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <Link
              ...
              title="Playing"
            >
              <svg className="w-5 h-5 text-ctp-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {collections.length > 0 && (
            <div className="pt-3 border-t border-ctp-surface0">
              ...
              >
                ...
                <span className="text-xs text-ctp-subtext0 font-medium">{collections.length}</span>
              </Link>
            </div>
          )}
          ...
          {franchises.length > 0 && (
            <div className="pt-3 border-t border-ctp-surface0">
              ...
              >
                ...
                <span className="text-xs text-ctp-subtext0 font-medium">{franchises.length}</span>
              </Link>
            </div>
          )}
            </>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <svg className="w-4 h-4 text-ctp-mauve" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                      </svg>
                  ...
                  <div className="space-y-1">
                    {collections.slice(0, 5).map((collection) => (
                      ...
                      >
                        ...
                        <span className="text-ctp-overlay1 text-xs">{collection.game_count}</span>
                      </Link>
                    ))}
                  ...
                  <div className="space-y-1">
                    {franchises.slice(0, 5).map((franchise) => (
                      <Link
                        ...
                        className="flex items-center justify-between text-sm px-2 py-1.5 rounded hover:bg-ctp-surface0 transition-colors"
                      >
                        <span className="text-ctp-subtext1 truncate">{franchise.series_name}</span>
                        <span className="text-ctp-overlay1 text-xs">{franchise.game_count}</span>
                      </Link>
                    ))}
                    {franchises.length > 5 && (
                      <Link
