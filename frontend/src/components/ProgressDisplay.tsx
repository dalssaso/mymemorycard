  ...
  if (isLoading) {
    return (
      <div className="bg-surface/50 animate-pulse rounded-lg p-3">
        <div className="mb-2 h-4 w-1/2 rounded bg-elevated" />
    ...
    <div className="bg-surface/50 rounded-lg border border-elevated p-3">
      <Link to="." hash="stats" className="group block transition-opacity hover:opacity-80">
        <div className="mb-2 flex items-center justify-between">
          <span className="text-xs text-text-secondary group-hover:text-text-muted">
          ...
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="h-3.5 w-3.5 text-text-muted group-hover:text-accent"
          >
        ...
        <div className="mt-2 h-1.5 w-full rounded-full bg-base">
          <div
            className="h-1.5 rounded-full transition-all duration-smooth"
            style={{
