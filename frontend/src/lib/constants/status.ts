...
export const STATUS_CONFIGS: Record<string, StatusConfig> = {
  ...
  favorites: {
    ...
    iconFill: true,
    color: "status-favorites",
    bgStyle: {
      backgroundColor: `color-mix(in srgb, ${colors.status.favorites} 35%, transparent)`,
    },
    activeStyle: {
      backgroundColor: `color-mix(in srgb, ${colors.status.favorites} 35%, transparent)`,
      borderColor: `color-mix(in srgb, ${colors.status.favorites} 55%, transparent)`,
    },
  },
