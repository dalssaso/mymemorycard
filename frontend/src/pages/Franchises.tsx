        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3">
              ...
              />
              <h1 className="text-4xl font-bold text-text-primary">Franchises</h1>
            </div>
            <p className="mt-1 text-text-secondary">Game series in your library</p>
          </div>
          <Button
        ...
        {franchises.length === 0 ? (
          <Card className="px-6 py-10" padded={true}>
            <div className="grid gap-6 text-center md:grid-cols-[2fr_1fr] md:text-left">
              <div>
                <h2 className="mb-3 text-2xl font-bold text-text-primary">No Franchises Yet</h2>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
            {franchises.map((franchise: FranchiseSummary) => (
              ...
              >
                <div className="relative mb-2 aspect-[3/4] overflow-hidden rounded-lg bg-surface ring-0 ring-transparent transition-shadow group-focus-visible:ring-2 group-focus-visible:ring-accent group-focus-visible:ring-offset-2 group-focus-visible:ring-offset-base">
